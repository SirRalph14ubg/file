...
, function(t, e, n) {
    ...
    : function(t) {
      ...
      , X = function(t) {
        ...
        return !(this === z && i(U, t) && !i(B, t)) && (!(e || !i(this, t) || !i(U, t) || i(this, L) && this[L][t]) || e)
    }
      , $ = function(t, e) {
        if (t = w(t),
        e = A(e, !0),
      ...
      , tt = function(t) {
        for (var e, n = t === z, r = I(n ? B : w(t)), o = [], a = 0; r.length > a; )
            !i(U, e = r[a++]) || n && !i(z, e) || o.push(U[e]);
        return o
    };
    W || (M = function() {
    ...
    n(44).f = X,
    n(43).f = tt,
    o && !n(28) && u(z, "propertyIsEnumerable", X, !0),
    p.f = function(t) {
        return H(h(t))
    }
    ),
...
, function(t, e, n) {
    ...
    if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
        ...
        ;
        for (var w, A = n(6) ? c(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), k = 0; A.length > k; k++)
            i(v, w = A[k]) && !i(p, w) && l(p, w, f(v, w));
        p.prototype = y,
        y.constructor = p,
        n(18)(r, h, p)
    }
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n, m, b, w, A) {
        ...
        }, S = e + " Iterator", T = b == y, P = !1, O = t.prototype, I = O[d] || O[p] || b && O[b], M = I || x(b), j = b ? T ? x("entries") : M : void 0, R = "Array" == e ? O.entries || I : I;
        if (R && (E = l(R.call(new t)),
        E !== Object.prototype && (f(E, S, !0),
        r || u(E, d) || a(E, d, g))),
        T && I && I.name !== y && (P = !0,
        M = function() {
            return I.call(this)
...
, function(t, e, n) {
    ...
    t.exports = function(t, e) {
        ...
        return function(e, u, p) {
            for (var v, y, g = o(e), m = i(g), b = r(u, p, 3), w = a(m.length), A = 0, k = n ? h(e, w) : s ? h(e, 0) : void 0; w > A; A++)
                if ((d || A in m) && (v = m[A],
                y = b(v, A, g),
                t))
                    if (n)
...
, function(t, e, n) {
    "use strict";
    var r, i, o, a = n(28), u = n(4), s = n(20), c = n(75), f = n(8), l = n(13), d = n(21), h = n(205), p = n(206), v = n(207), y = n(208).set, g = n(209)(), m = "Promise", b = u.TypeError, w = u.process, A = u[m], w = u.process, k = "process" == c(w), _ = function() {}, E = !!function() {
        try {
            var t = A.resolve(1)
            ...
            ;
            return (k || "function" == typeof PromiseRejectionEvent) && t.then(_)instanceof e
        } catch (t) {}
    }(), x = function(t, e) {
        return t === e || t === A && e === o
    }, S = function(t) {
    ...
    , O = function(t) {
            ...
            g(function() {
                for (var r = t._v, i = 1 == t._s, o = 0, a = function(e) {
                    ...
                    try {
                        ...
                        n = a(r),
                        c && c.exit()),
                        n === e.promise ? s(b("Promise-chain cycle")) : (o = S(n)) ? o.call(n, u, s) : u(n)) : s(r)
                    } catch (t) {
                        s(t)
                    }
                }; n.length > o; )
        ...
        y.call(u, function() {
            var e, n, r, i = t._v;
            if (j(t) && (e = O(function() {
                k ? w.emit("unhandledRejection", i, t) : (n = u.onunhandledrejection) ? n({
                    promise: t,
                    reason: i
        ...
        y.call(u, function() {
            var e;
            k ? w.emit("rejectionHandled", t) : (e = u.onrejectionhandled) && e({
                promise: t,
                reason: t._v
            })
        })
    ...
    f(f.S + f.F * (a || !E), m, {
        resolve: function(t) {
            if (t instanceof A && x(t.constructor, this))
                return t;
            var e = T(this)
              , n = e.resolve;
            return n(t),
...
, function(t, e, n) {
    ...
    if (a.ABV) {
        if (!c(function() {
            ...
            ;
            for (var X, $ = k[b] = T[b], Z = h(T), tt = 0; Z.length > tt; )
                (X = Z[tt++])in k || u(k, X, T[X]);
            o || ($.constructor = k)
        }
        ...
        !et.getInt8(0) && et.getInt8(1) || s(_[b], {
...
, function(t, e, n) {
    ...
    if (n(6)) {
        var r = n(28)
          ...
          , Ft = function(t) {
            var e, n, r, i, o, a, u = k(t), s = arguments.length, f = s > 1 ? arguments[1] : void 0, l = void 0 !== f, d = T(u);
            if (void 0 != d && !_(d)) {
                for (a = d.call(u),
                r = [],
                e = 0; !(o = a.next()).done; e++)
          ...
          , Vt = function(t, e) {
            return A(t) && t[_t] && "symbol" != typeof e && e in t && String(+e) == String(e)
        }
          , Gt = function(t, e) {
            return Vt(t, e = g(e, !0)) ? l(2, t[e]) : W(t, e)
        }
          , Ht = function(t, e, n) {
            return !(Vt(t, e = g(e, !0)) && A(n) && m(n, "value")) || m(n, "get") || m(n, "set") || n.configurable || m(n, "writable") && !n.writable || m(n, "enumerable") && !n.enumerable ? z(t, e, n) : (t[e] = n.value,
            t)
        };
        kt || (B.f = Gt,
        U.f = Ht),
        ...
        t.exports = function(t, e, n, s) {
            ...
            b ? (y = n(function(t, n, r, i) {
                ...
                if (A(n)) {
                    if (!(n instanceof X || (s = w(n)) == H || s == K))
                        return _t in n ? Ct(y, n) : Ft.call(y, n);
                    o = n,
                    h = It(r, e);
                    var p = n.byteLength;
                    if (void 0 === i) {
            ...
            _ = y[Q] = E(Kt),
            d(_, "constructor", y)) : L(function(t) {
                new y(null),
                new y(t)
            }, !0) || (y = n(function(t, n, r, i) {
                f(t, y, c);
                var o;
                return A(n) ? n instanceof X || (o = w(n)) == H || o == K ? void 0 !== i ? new g(n,It(r, e),i) : void 0 !== r ? new g(n,It(r, e)) : new g(n) : _t in n ? Ct(y, n) : Ft.call(y, n) : new g(Ot(n, l))
            }),
            Z(m !== Function.prototype ? S(g).concat(S(m)) : S(g), function(t) {
                t in y || d(y, t, g[t])
            }),
            y[Q] = _,
            r || (_.constructor = y));
...
, function(t, e, n) {
    (function(e, n) {
        !function(e) {
            ...
            var g, m = Object.prototype, b = m.hasOwnProperty, w = "function" == typeof Symbol ? Symbol : {}, A = w.iterator || "@@iterator", k = w.toStringTag || "@@toStringTag", _ = "object" == typeof t, E = e.regeneratorRuntime;
            if (E)
            ...
            u.constructor = a,
            u[k] = a.displayName = "GeneratorFunction",
    ...
    var o = function() {
      ...
      , m = function() {
        ...
        return o(t, [{
            ...
            key: "getDistributorId",
            value: function() {
                return this.app.distributorId << 0
            }
        }, {
            key: "getAdReady",
            value: function() {
      ...
      , D = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                this.distributorId = t.distributorId
            }
        }, {
            key: "setupDefaultEvents",
            value: function() {
            ...
            value: function() {
                var e = this
                  ...
                  , b = n.adTiming
                  , A = void 0 === b ? {} : b
                  , _ = n.timeUpdateInterval
                  , x = n.waterfallRetries;
                this.debug = !!i;
                var T = !1
                  , O = {};
                ...
                this.videoTimer = new k.default({
                    timeUpdateInterval: _
                }),
                y.init({
                    wrapper: s,
                    fullScreen: f,
            ...
            value: function() {
                ...
                (t.isPokiPlatform || r === m.default.ads.position.rewarded) && (a = u({}, a, o, {
                    domainCode: (0,
                    j.default)((0,
                    C.default)("url_referrer"))
                })),
                this.distributorId << 0 === 2 && (a.tag = encodeURIComponent((0,
                C.default)("tag") || "")),
                this.gameId << 0 === 228 && (this.distributorId << 0 === 2 || this.distributorId << 0 === 1)) {
                    var s = null
                      , c = "//.net/gampad/ads?sz=320x240|320x300|400x300|640x360|640x480&iu={adUnit}&ciu_szs&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url={url}&description_url={descriptionUrl}&correlator={timestamp}";
...
, function(t, e, n) {
    "use strict";
    var r, i, o, a = n(343), u = n(305), s = n(307), c = n(358), f = n(304), l = n(312), d = n(308), h = n(359), p = n(360), v = n(364), y = n(365).set, g = n(367)(), m = "Promise", b = u.TypeError, w = u.process, A = u[m], w = u.process, k = "process" == c(w), _ = function() {}, E = !!function() {
        try {
            var t = A.resolve(1)
...
, function(t, e) {
    ...
    e.default = {
        hash: "G1L1",
        adTagUrl: "//puubleclick.net/gampad/ads?sz=320x240|320x300|400x300|640x360|640x480&iu=/1053551/Pub-Poki-Generic&ciu_szs&impl=s&gdfp_req=1&env=vp&output=xml_vast2&unviewed_position_start=1&url={url}&description_url={descriptionUrl}&correlator={timestamp}",
        adTiming: {
            preroll: !0,
            timeBetweenAds: 12e4,
            timePerTry: 7e3,
...
, function(t, e, n) {
    ...
    function i() {
        if (O.wrapper === document.body || O.wrapper === window)
            return {
                width: window.innerWidth,
                height: window.innerHeight
            };
        var t = O.wrapper.getBoundingClientRect();
        return {
            width: t.width,
            height: t.height
        }
    ...
    var o = Object.assign || function(t) {
      ...
      , E = void 0
      , x = void 0
      , S = e.getVideoContainer = function() {
        return x || (x = document.createElement("div")),
        x
    }
      , T = e.getInsideContainer = function() {
        return _ || (_ = document.createElement("div")),
        _
    }
      , P = e.getPauseContainer = function() {
      ...
      , I = (e.init = function(t) {
        ...
        g = .95),
        O = o({}, O, t),
        O.remainingAdTimeCallback && R(O.remainingAdTimeCallback),
        ...
        O.wrapper instanceof HTMLElement || (console.error("POKI-SDK: wrapper is not a HTMLElement, falling back to document.body"),
        O.wrapper = document.body),
        ["absolute", "fixed"].indexOf(O.wrapper.style.position) === -1 && (O.wrapper.style.position = "relative"),
        m.id = "poki-sdk-container",
        ...
        O.wrapper.appendChild(b),
        O.wrapper.appendChild(m),
        m.style.position = "absolute",
        m.style.zIndex = 9999,
        m.style.display = "none",
        _.style.cssText = "background:black;position:absolute;left:0;top:0;right:0;height:" + 100 * (1 + v) + "%;",
        E.id = "poki-play-container",
        w.id = "poki-play-button",
        E.appendChild(w),
        _.appendChild(E),
        _.appendChild(x),
    ...
    void 0)
      ...
      , j = void 0
      , R = function(t) {
        c.default.addEventListener(l.default.ads.started, function(e) {
            j = e.remainingTime,
            I = window.setInterval(function() {
                if (!M) {
                    var e = t()
                      , n = (j - e) / j * 100;
                    n < 100 ? k.style.width = n + "%" : window.clearInterval(I)
                }
            }, 10)
        }),
        c.default.addEventListener(l.default.ads.durationChange, function(t) {
            j = t.duration
        })
    }
      , C = (e.hide = function() {
    ...
    e.show = function() {
        ...
        _.style.top = 0,
        _.style.transition = ".5s top",
        window.setTimeout(function() {
            _.style.top = parseInt(_.getAttribute("data-position-top"), 10) + "px"
        }, 0)
    }
    ,
    e.pause = function() {
    ...
    e.resize = function(t, e) {
        ...
        b.style.height = n.height + "px",
        m.style.width = n.width + "px",
        m.style.height = n.height + "px",
        _.style.width = parseInt(t, 10) + "px",
        _.style.height = parseInt(e, 10) + "px",
        E.style.width = parseInt(t, 10) + "px",
        E.style.height = parseInt(e, 10) + "px",
        A.style.height = r + "px",
        A.style.bottom = "0",
        _.style.left = (n.width - t) / 2 + "px",
        _.style.top = (n.height - e) / 2 + "px",
        _.setAttribute("data-height", parseInt(e, 10)),
        _.setAttribute("data-position-top", parseInt(_.style.top, 10))
    }
    ;
    c.default.addEventListener(l.default.ads.paused, function() {
        C()
    }),
    c.default.addEventListener(l.default.ads.resumed, function() {
        L()
    })
}
, function(t, e) {
    ...
    var o = function() {
      ...
      , E = function() {
        function t() {
            ...
            _.default)(e.adTagUrl) : [g.default.adTagUrl],
          ...
          , r = {
            init: function() {
                if (!t) {
                    ...
                    t = !0;
                    var e = "";
                    PokiAnalytics("create", e, "auto"),
                    PokiAnalytics("send", "pageview"),
                    "undefined" != typeof window.pokiGameTracker && (PokiAnalytics("create", window.pokiGameTracker, "auto", {
                        name: "second"
                    }),
